// ============================================================
// script.js — DevFlow IDE Landing Page
// ============================================================


// ============================================================
// 1. SCROLL REVEAL ANIMATION
//    كل عنصر عنده class "reveal" هيظهر بـ animation
//    لما يدخل في الشاشة أثناء الـ scroll
// ============================================================
  ...
  (entries) => {
    entries.forEach((entry) => {
      if (entry.isIntersecting) {
        ...
        revealObserver.unobserve(entry.target); // بعد ما يظهر مش محتاجينه تاني
      }
    });
  },
  { threshold: 0.15 }
...
// ============================================================
// 2. NAVBAR — STICKY + SHRINK ON SCROLL
//    الـ header بيتغير شكله لما تنزل تحت
// ============================================================
...
// ============================================================
// 3. SMOOTH SCROLL للـ anchor links
// ============================================================
...
// ============================================================
// 4. DEPLOY BUTTON — Toast Notification
// ============================================================
...
// ============================================================
// 7. TERMINAL CODE — TYPEWRITER EFFECT
//    الكود في الـ Hero بيتكتب تدريجياً زي Terminal حقيقي
// ============================================================
...
// تشغيل الـ typewriter لما الـ terminal يظهر في الشاشة
...
// ============================================================
// 8. TERMINAL DOTS — مثل macOS (Minimize/Close/Full)
// ============================================================
...
dotRed?.addEventListener("click", () => showToast("❌ Close — not yet!", "error"));
...
// ============================================================
// 9. LANG TAGS في الـ Features — تفلتر وتبرز
// ============================================================
document.querySelectorAll(".lang-tags span").forEach((tag) => {
  ...
  tag.addEventListener("click", () => {
    ...
    document.querySelectorAll(".lang-tags span").forEach((t) =>
      t.classList.remove("lang-active")
    );
...
// ============================================================
// 10. COUNTER ANIMATION لـ "100k+ developers"
//     رقم بيعد من 0 لـ 100 لما تشوفه
// ============================================================
...
// ============================================================
// 12. DYNAMIC STYLES — بنضيفهم بـ JS عشان مش عندنا CSS file
// ============================================================
